...
/**
 * All icon components share the same prop signature as a native
 * <svg> element, so callers can pass `className`, `onClick`,
 * `aria-hidden`, `strokeWidth`, etc. directly — matching how the
 * original HTML inlined raw SVGs with Tailwind classes.
 *
 * Default `className` provides a sensible fallback size ("w-5 h-5")
 * but can always be overridden by the caller via `cn()` at the
 * call site if needed.
 */
type IconProps = SVGProps<SVGSVGElement>;

/** Hamburger menu icon — used by the mobile menu toggle button. */
...
/** Close (X) icon — used by the offcanvas close button. */
...
/** Brand logo icon (graduation-cap style mark used next to the wordmark). */
...
/** Chevron pointing down — used for dropdown toggles (rotates when open). */
...
/** Chevron pointing left — used as a "go to submenu" indicator (RTL). */
...
/** Magnifying glass — used in the search input. */
...
/** Sun icon — shown in light mode (toggles to MoonIcon in dark mode). */
...
/** Generic user/avatar placeholder icon. */
...
/** Four-pointed sparkle icon — used as a decorative badge marker. */
...
/** Lightning bolt icon — used in the "discount festival" promo badge. */
...
/** Question-mark-in-circle icon — used for the "Q&A" mobile shortcut. */
...
/** Document/article icon — used for the "Articles" mobile shortcut. */
...
/** Grid/category icon — used on the "Categories" mobile accordion trigger. */
...
/** Sparkle/stars icon — used on the "مشاهده پروفایل" user menu link. */
...
/** Graduation cap / courses icon — used on the "دوره ها" user menu link. */
...
/** Banknote / wallet icon — used on the "مالی" user menu link. */
...
/** Chat bubble icon — used on the "پرسش و دیدگاه ها" user menu link. */
...
/** Arrow-left-from-bracket icon — used on the "خروج از حساب" logout button. */
...
export function SupportPhoneIcon(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
/** Puzzle piece icon — "چالش‌برانگیز" feature. */
...
/**
 * ─── Features badges icons (second set) ─────────────────────────────────────
 */

/** Code bracket icon — "توسعه اختصاصی نرم‌افزار" badge. */
...
/** Circle stack (database) icon — "معماری نرم‌افزار مقیاس‌پذیر" badge. */
...
/** Swatch/palette icon — "طراحی حرفه‌ای UI/UX" badge. */
export function SwatchIcon(props: IconProps) {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M3.75 3A1.75 1.75 0 0 0 2 4.75v3.26a3.235 3.235 0 0 1 1.75-.51h12.5c.644 0 1.245.188 1.75.51V6.75A1.75 1.75 0 0 0 16.25 5h-4.836a.25.25 0 0 1-.177-.073L9.823 3.513A1.75 1.75 0 0 0 8.586 3H3.75ZM2 12.75a3.25 3.25 0 0 0 3.25 3.25h9.5A3.25 3.25 0 0 0 18 12.75v-3.5a1.75 1.75 0 0 0-1.75-1.75H3.75A1.75 1.75 0 0 0 2 9.25v3.5Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
/** Bolt icon — "توسعه سریع و استاندارد" badge. */
...
/** Lock closed icon — "امنیت و پایداری بالا" badge. */
...
/** Wrench-screwdriver icon — "پشتیبانی و توسعه بلندمدت" badge. */
export function WrenchIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10 3.75a2 2 0 1 0-4 0 2 2 0 0 0 4 0ZM17.25 4.5a.75.75 0 0 0 0-1.5h-5.5a.75.75 0 0 0 0 1.5h5.5ZM5 3.75a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1 0-1.5h1.5a.75.75 0 0 1 .75.75ZM4.25 17a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75ZM17.25 17a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75ZM11 15.25a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1 0-1.5h1.5a.75.75 0 0 1 .75.75ZM10 10a2 2 0 1 0-4 0 2 2 0 0 0 4 0ZM17.25 10.5a.75.75 0 0 0 0-1.5h-5.5a.75.75 0 0 0 0 1.5h5.5ZM5 10a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1 0-1.5h1.5A.75.75 0 0 1 5 10ZM10 16.25a2 2 0 1 0-4 0 2 2 0 0 0 4 0Z" />
    </svg>
  );
}

/** Fire/flame icon — "پروژه‌محور" feature. */
...
/** Forward/fast-forward icon — "به‌روز" feature. */
...
/** Video camera icon — "ویدیویی" feature. */
...
/** Chat-bubble icon — "منتورشیپ" feature. */
...
/** Open book icon — "در حال یادگیری" tab. */
...
/** Chat bubbles icon — "جامعه فعال برنامه نویسان" tab. */
...
/** Shield-check icon — "گارانتی بازگشت وجه" tab. */
...
/** Trophy icon — "استعداد سنجی و ارزیابی" tab. */
...
export function LightBulbIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10 2a6 6 0 0 0-3.75 10.68c.37.3.75.86.75 1.32V15a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-1c0-.46.38-1.02.75-1.32A6 6 0 0 0 10 2ZM7.5 17a.75.75 0 0 0 0 1.5h5a.75.75 0 0 0 0-1.5h-5Z" />
    </svg>
  );
}
...
export function CursorIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M3.5 2.75a.75.75 0 0 1 .96-.72l11.5 4a.75.75 0 0 1 .04 1.4l-4.7 1.8 1.8 4.7a.75.75 0 0 1-1.4.54l-1.8-4.7-4.7 1.8a.75.75 0 0 1-1-.7V2.75Z" />
    </svg>
  );
}
...
export function CodeIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M6.78 5.22a.75.75 0 0 1 0 1.06L4.06 9l2.72 2.72a.75.75 0 1 1-1.06 1.06l-3.25-3.25a.75.75 0 0 1 0-1.06l3.25-3.25a.75.75 0 0 1 1.06 0Zm6.44 0a.75.75 0 0 1 1.06 0l3.25 3.25a.75.75 0 0 1 0 1.06l-3.25 3.25a.75.75 0 0 1-1.06-1.06L15.94 9l-2.72-2.72a.75.75 0 0 1 0-1.06Z" />
    </svg>
  );
}

export function SupportIcons(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
      ...
      {...props}
    >
      <path d="M10 2a6 6 0 0 0-6 6v3a2 2 0 0 0 2 2h1v-4H6a4 4 0 1 1 8 0h-1v4h1a2 2 0 0 0 2-2V8a6 6 0 0 0-6-6Z" />
      <path d="M7 13h6v2a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-2Z" />
    </svg>
  );
}
...
/** Chevron up icon — used in the scroll-to-top button. */
...
/** Clock icon — used for business hours in the footer. */
...
/** Envelope icon — used in the newsletter form. */
...
/** Instagram icon — social media footer link. */
...
/** Telegram icon — social media footer link. */
...
/** YouTube icon — social media footer link. */
...
/** Funnel/filter icon — used on the mobile "فیلتر مقالات" trigger button. */
...
/** Curved reply-arrow icon — used on the "پاسخ" comment reply button. */
...
/** Dashboard/grid-layout icon — used on the "پیشخوان" sidebar link. */
...
/** Wallet/subscription icon — used on "مالی و اشتراک" and the wallet stat tile. */
...
/** Bell/notification icon — used on the "اعلانات" sidebar link. */
...
/** Pencil/edit icon — used on the "ویرایش پروفایل" sidebar link. */
...
/** Snowflake/subscription-status icon — used on the "باقیمانده اشتراک" stat tile. */
...
/** Star icon — used on the "امتیازات" stat tile. */
...
export function AboutUsIcon(props: IconProps) {
  return (
    <svg
      ...
      fill="currentColor"
      aria-hidden="true"
      className="w-10 h-10 text-yellow-500 -rotate-[120deg]"
      {...props}
    >
      <path d="M12 .75a8.25 8.25 0 0 0-4.135 15.39c.686.398 1.115 1.008 1.134 1.623a.75.75 0 0 0 .577.706c.352.083.71.148 1.074.195.323.041.6-.218.6-.544v-4.661a6.714 6.714 0 0 1-.937-.171.75.75 0 1 1 .374-1.453 5.261 5.261 0 0 0 2.626 0 .75.75 0 1 1 .374 1.452 6.712 6.712 0 0 1-.937.172v4.66c0 .327.277.586.6.545.364-.047.722-.112 1.074-.195a.75.75 0 0 0 .577-.706c.02-.615.448-1.225 1.134-1.623A8.25 8.25 0 0 0 12 .75Z" />
      <path
...
/** Filled ribbon/rules icon — used on the terms-and-conditions page hero. */
